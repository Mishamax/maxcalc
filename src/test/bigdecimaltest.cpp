...
void BigDecimalTest::toString()
{
    ...
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT)), std::string("1E+2"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT)), std::string("100"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT, BigDecimalFormat::UPPER_CASE_EXPONENT)), std::string("100"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT, BigDecimalFormat::LOWER_CASE_EXPONENT)).c_str(), std::string("1e+2").c_str());

    dec = 100000;
    COMPARE(dec.toString(), std::string("100000"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT)), std::string("1E+5"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT)), std::string("100E+3"));

    dec = 1000000;
    COMPARE(dec.toString(), std::string("1E+6"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT)), std::string("1E+6"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT)), std::string("1E+6"));

    dec = "1E-5";
    COMPARE(dec.toString(), std::string("0.00001"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT)), std::string("0.00001"));
    COMPARE(dec.toString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT)), std::string("0.00001"));
...
void BigDecimalTest::toWideString()
{
    ...
    COMPARE(dec.toWideString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT)), std::wstring(L"1E+2"));
    COMPARE(dec.toWideString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT)), std::wstring(L"100"));
    COMPARE(dec.toWideString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::ENGINEERING_FORMAT, BigDecimalFormat::UPPER_CASE_EXPONENT)), std::wstring(L"100"));
    COMPARE(dec.toWideString(BigDecimalFormat(MAX_IO_PRECISION, BigDecimalFormat::SCIENTIFIC_FORMAT, BigDecimalFormat::LOWER_CASE_EXPONENT)), std::wstring(L"1e+2"));
...
void BigDecimalTest::toInt()
{
    ...
    dec = "10.1";
    FAIL_TEST(dec.toInt(), "(10.1).toInt()", ArithmeticException);
}
...
void BigDecimalTest::binaryArithmeticOperators()
{
    ...
    FAIL_TEST(dec2 /= 0, "Division by zero", ArithmeticException);
...
void BigDecimalTest::binaryLogicalOperators()
{
    ...
    FAIL_TEST(dec | 1.1, "dec | 1.1", ArithmeticException);
    FAIL_TEST(dec & 1.1, "dec & 1.1", ArithmeticException);
    FAIL_TEST(dec ^ 1.1, "dec ^ 1.1", ArithmeticException);
    FAIL_TEST(dec << 1.1, "dec << 1.1", ArithmeticException);
    FAIL_TEST(dec >> 1.1, "dec >> 1.1", ArithmeticException);
    FAIL_TEST(~BigDecimal(-2.56), "~BigDecimal(-2.56)", ArithmeticException);
    FAIL_TEST(BigDecimal(1.1) | 1, "BigDecimal(1.1) | 1", ArithmeticException);
    FAIL_TEST(BigDecimal(1.1) & 1, "BigDecimal(1.1) & 1", ArithmeticException);
    FAIL_TEST(BigDecimal(1.1) ^ 1, "BigDecimal(1.1) ^ 1", ArithmeticException);
    FAIL_TEST(BigDecimal(1.1) << 1, "BigDecimal(1.1) << 1", ArithmeticException);
    FAIL_TEST(BigDecimal(1.1) >> 1, "BigDecimal(1.1) >> 1", ArithmeticException);
...
void BigDecimalTest::exp()
{
    ...
    FAIL_TEST(BigDecimal::exp(12345678), "Exponent overflow", ArithmeticException);
    FAIL_TEST(BigDecimal::exp(BigDecimal::ln(0)), "ln(0)", InvalidArgumentException);
}
...
void BigDecimalTest::ln()
{
    ...
    FAIL_TEST(BigDecimal::ln(0), "ln(0)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::ln(-5), "ln(-5)", InvalidArgumentException);
}
...
void BigDecimalTest::log10()
{
    ...
    FAIL_TEST(BigDecimal::log10(0), "log10(0)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::log10(-5), "log10(-5)", InvalidArgumentException);
}
...
void BigDecimalTest::sqrt()
{
    ...
    FAIL_TEST(BigDecimal::sqrt(-10), "sqrt(-10)", InvalidArgumentException);
}
...
void BigDecimalTest::pow()
{
    ...
    FAIL_TEST(BigDecimal::pow(0, -437), "pow(0, -437)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::pow(-12, -437), "pow(-12, -437)", InvalidArgumentException);
}
...
void BigDecimalTest::div()
{
    ...
    FAIL_TEST(BigDecimal::div(4, 0), "div(4, 0)", ArithmeticException);
    FAIL_TEST(BigDecimal::div(0, 0), "div(0, 0)", ArithmeticException);
}
...
void BigDecimalTest::factorial()
{
    ...
    FAIL_TEST(BigDecimal::factorial(-1), "factorial(-1)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::factorial("1.2"), "factorial(1.2)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::factorial("-1.2"), "factorial(-1.2)", InvalidArgumentException);
}
...
void BigDecimalTest::tan()
{
    ...
    FAIL_TEST(BigDecimal::tan(-BigDecimal::PI / 2), "tan(-pi/2)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::tan(BigDecimal::PI / 2), "tan(pi/2)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::tan(BigDecimal::PI / 2 * 3), "tan(3*pi/2)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::tan(BigDecimal::PI / 2 * 101), "tan(101*pi/2)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::tan(BigDecimal::PI / 2 * 10000001), "tan(10000001*pi/2)", InvalidArgumentException);
}
...
void BigDecimalTest::cot()
{
    ...
    FAIL_TEST(BigDecimal::cot(-BigDecimal::PI), "cot(-pi)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::cot(0), "cot(0)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::cot(BigDecimal::PI), "cot(pi)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::cot(BigDecimal::PI * 3), "cot(3*pi)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::cot(BigDecimal::PI * 101), "cot(101*pi)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::cot(BigDecimal::PI * 10000001), "cot(10000001*pi)", InvalidArgumentException);
}
...
void BigDecimalTest::arcsin()
{
    ...
    FAIL_TEST(BigDecimal::arcsin("1.1"), "arcsin(1.1)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::arcsin(-2), "arcsin(-2)", InvalidArgumentException);
}
...
void BigDecimalTest::arccos()
{
    ...
    FAIL_TEST(BigDecimal::arccos("1.1"), "arccos(1.1)", InvalidArgumentException);
    FAIL_TEST(BigDecimal::arccos(-2), "arccos(-2)", InvalidArgumentException);
}
